      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href="/get"
              className="px-8 py-4 bg-primary hover:bg-primary/80 text-black font-bold text-lg rounded-none skew-x-[-10deg] transition-all hover:scale-105 hover:shadow-[0_0_20px_var(--color-primary-glow)] flex items-center gap-2 group"
            >
            ...
            <Link
              href="/tournaments"
              className="px-8 py-4 bg-transparent border border-primary/50 text-primary hover:border-primary hover:text-white font-bold text-lg rounded-none skew-x-[-10deg] transition-all hover:bg-primary/10"
            >
      ...
      <section className="py-24 bg-black relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-white">
            WHY <span className="text-primary">ARGON?</span>
          </h2>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="p-8 border border-primary/20 bg-black/40 backdrop-blur-sm hover:border-primary/60 transition-all hover:-translate-y-2 group">
