                ...
                <div className="flex items-center gap-4">
                    {loading ? (
                        ...
                        <div className="relative group">
                            <Link href="/profile" className="flex items-center gap-3 md:pl-2 md:pr-4 md:py-1.5 p-0.5 rounded-full glass hover:bg-white/10 transition-all">
                                <img
                                ...
                                <ChevronDown size={14} className="hidden md:block text-gray-400 group-hover:text-white transition-colors" />
                            </Link>
                                ...
                                {user ? (
                                    <>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <MobileNavLink href="/profile" onClick={() => setIsOpen(false)} icon={<UserIcon size={20} />} delay={4}>Profile</MobileNavLink>
                                            <MobileNavLink href="/servers" onClick={() => setIsOpen(false)} icon={<LayoutDashboard size={20} />} delay={5}>Dashboard</MobileNavLink>
                                        </div>
    ...
    return (
        ...
        >
            <Link
                href={href}
                onClick={onClick}
                className="flex items-center gap-4 text-xl font-bold text-gray-300 hover:text-white p-4 rounded-3xl hover:bg-white/5 hover:border-white/10 border border-transparent transition-all group active:scale-95"
            >
                {icon && (
                    <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-gray-400 group-hover:text-primary group-hover:bg-primary/10 transition-colors border border-white/5 shadow-sm">
                        {icon}
                    </div>
                )}
